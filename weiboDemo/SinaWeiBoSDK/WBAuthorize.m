...
- (void)dealloc
{
    ...
    [_loginDialog release],_loginDialog=nil;
    [super dealloc];
}
...
//    [webView release];
 ...
 _loginDialog = [[TencentLoginView alloc] initWithURL:kWBAuthorizeURL
                                                  params:params
                                                delegate:self];
    _loginDialog.loginType=@"sina";
    [_loginDialog show];
...
//    }
//}
- (void)authorizeLoginView:(TencentLoginView *)weibologinView didReceiveAuthorizeCode:(NSString *)code{
       if (![code isEqualToString:@"21330"])
    {
           [self requestAccessTokenWithAuthorizeCode:code];
//            [rootViewController  dismissModalViewControllerAnimated:YES];
